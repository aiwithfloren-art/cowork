...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "2. Per bisnis (max 5 http_request total): `web_search({query: '<name> contact email instagram whatsapp'})`. Snippet sering surface kontak langsung.",
      ...
      "   - Gak nemu → `NOT_FOUND`",
      "4. `create_google_sheet({title:'Lead Gen <niche> <kota>', headers:['Business Name','Website','Instagram','WhatsApp','Email','Status'], rows: N rows × 6 kolom})`",
      "5. `save_note({content:'lead-gen-sheet-id: <spreadsheet_id>, title: <title>', type:'reference'})`",
      "6. Reply: '✅ N prospect di Sheet: <link>. Email X/N, WA Y/N, IG Z/N.'",
      "",
