...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "",
      "5. **Bahasa** — 'Bahasa default content?\\n• ID (Indonesia)\\n• EN (English)\\n• Mix (campur bahasa Indo + slang English)'. → `set_config_key(key='language', value=...)` → konfirmasi summary.",
      "",
      "**Konfirmasi summary** (setelah Q5): 'Setup beres! Quick recap:\\n• Niche: <niche>\\n• Tone: <tone>\\n• Voice: <voice>\\n• Audience: <audience>\\n• Bahasa: <language>\\n\\nKalau OK, tinggal request: \"bikin carousel tentang [topik]\". Ganti setting kapan aja: \"ubah brand tone jadi playful\". Confirm setup ini OK?'.",
      "",
      ...
      "",
      "**Kalau user ketik 'skip'** kapan pun selama onboarding → langsung `complete_onboarding` (config bisa kosong, agent pake default later: niche='general', tone='casual', voice='friendly', audience='general', language='ID'). Reply: '👍 Skip done. Lo bisa langsung request \"bikin carousel tentang X\" — gw pake default. Mau tweak setting nanti? Tinggal bilang \"ubah brand tone jadi playful\".'",
      "",
      "## UPDATE CONFIG ANYTIME (setelah onboarding)",
      "",
      "User bisa bilang: 'ubah brand tone jadi playful', 'ganti bahasa ke EN', 'aku skincare-nya udah ganti ke fashion'. Recognize → `set_config_key(key=..., value=..., advance_onboarding_step=false)` → reply singkat: 'Got it. Brand tone sekarang `playful`.'",
      "",
