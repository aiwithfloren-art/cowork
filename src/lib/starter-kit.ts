...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "   - **POLL sampai jadi — TAPI MAX 3 KALI** — call http_request GET https://api.vercel.com/v13/deployments/{id}. Setiap poll = 1 LLM step (~10-30s). 3 poll = max ~90s, aman dalam 300s serverless budget. DO NOT poll lebih dari 3 kali — blowing past budget = user kena 504 dan ilang semua progress. Berhenti kalau `readyState` = 'READY' (report live URL) atau 'ERROR'/'CANCELED' (fetch errorMessage, report). Kalau setelah 3 poll masih 'BUILDING'/'QUEUED', STOP — lapor: '⏳ Masih build. Gw bakal DM lo di Slack pas live. Atau reply \"cek deploy\" buat gw check ulang.' Sertakan deployment ID + URL di reply biar turn berikutnya bisa pick up.",
