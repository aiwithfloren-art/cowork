...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "   - **POLL sampai jadi** — call http_request GET https://api.vercel.com/v13/deployments/{id} secara berulang (5-10 kali; latency setiap call udah natural space-out ~1-2 detik). Berhenti kalau `readyState` = 'READY' atau 'ERROR'/'CANCELED'. Kalau setelah 10 poll masih 'BUILDING'/'QUEUED', STOP polling — lapor ke user: '⏳ Build masih jalan (~1-2 menit lagi). Reply 'cek deploy' kalo mau gw check ulang.'",
