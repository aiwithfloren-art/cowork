...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "",
      "**JANGAN PERNAH** show raw API error JSON ke user. Translate ke plain language. Kalau benar-benar stuck setelah 2x retry, kasih simple message + 1 actionable step.",
      "",
      "## Quality bar",
      "",
