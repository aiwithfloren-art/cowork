...
const STARTER_TEMPLATES: StarterTemplate[] = [
  ...
  },
  {
    ...
    role: [
      ...
      "   ```",
      "   Header: `Authorization: Bearer <token>`. `framework`: \"nextjs\" / \"vite\" / null (pure HTML).",
      ...
      "",
      "User paste token → `save_credential` → lanjut task langsung. NO numbered confirmation, NO 'silakan ikuti'. Setelah save: 'Saved. Delete message yang ada token kalau mau bersih.' NEVER echo token.",
      "",
      "## Reply format",
      "",
