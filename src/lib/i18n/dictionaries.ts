  ...
  en: {
    ...
    chat: {
      ...
      suggestions: {
        ...
        insightTitle: "🔍 Get insights",
        insight1: "Search my docs for project roadmap",
        insight2: "What tasks are overdue?",
      },
    },
    team: {
  ...
  id: {
    ...
    chat: {
      ...
      suggestions: {
        ...
        insightTitle: "🔍 Dapat insight",
        insight1: "Cari dokumen saya soal project roadmap",
        insight2: "Tugas apa saja yang sudah lewat deadline?",
      },
    },
    team: {
      title: "Workspace tim",
